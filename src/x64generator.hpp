...
class TX64Generator: public TBaseGenerator {
using inherited = TBaseGenerator;
public:
    TX64Generator (TRuntimeData &, bool codeRangeCheck = true, bool createCompilerListing = false);
...
*/    
    ...
    bool isCalcStackReg (TX64Reg);
    bool isXmmStackReg (TX64Reg);
    bool isXmmStackReg (const TX64Operand &);
    bool isXmmReg (const TX64Operand &);
    bool isCalcStackReg (const TX64Operand &);
    bool isSameReg (const TX64Operand &op1, const TX64Operand &op2);
    bool isSameCalcStackReg (const TX64Operand &op1, const TX64Operand &op2);
    bool isSameXmmReg (const TX64Operand &op1, const TX64Operand &op2);
    bool isSameXmmStackReg (const TX64Operand &op1, const TX64Operand &op2);
    bool isRegisterIndirectAddress (const TX64Operand &);
    bool isRIPRelative (const TX64Operand &);
    
    void modifyReg (TX64Operand &operand, TX64Reg a, TX64Reg b);
