...
procedure proc6 (p1, p2, p3, p4, p5, p6: double);
    begin
	print (p1); print (p2); print (p3); print (p4); print (p5); 
	print (p6)
    end;

procedure proc7 (p1, p2, p3, p4, p5, p6, p7: double);
    begin
	print (p1); print (p2); print (p3); print (p4); print (p5); 
	print (p6); print (p7)
    end;

procedure proc8 (p1, p2, p3, p4, p5, p6, p7, p8: double);
    begin
	print (p1); print (p2); print (p3); print (p4); print (p5);
	print (p6); print (p7); print (p8)
    end;

procedure proc9 (p1, p2, p3, p4, p5, p6, p7, p8, p9: double);
    begin
	print (p1); print (p2); print (p3); print (p4); print (p5);
	print (p6); print (p7); print (p8); print (p9)
    end;

procedure proc10 (p1, p2, p3, p4, p5, p6, p7, p8, p9, p10: double);
    begin
	print (p1); print (p2); print (p3); print (p4); print (p5);
